...
Selecciona un cliente de la lista<br/>
 ...
 <option value="">Cliente</option> 
    ...
    <option value="<?php echo $lista_usuario['alias']; ?>"><?php echo $lista_usuario['nombre']; ?>-<?php echo $lista_usuario['alias']; ?></option> 
