...
<div class="contenedor">
	...
	$(document).ready(function() 
	{
		...
		.done(function(json) {
			...
			{
				$('.editinplace').append(
					"<tr><td class='rfc'>"+json[i].rfc+"</td><td class='editable' data-campo='nombre'><span>"+json[i].nombre+"</span></td><td class='editable' data-campo='domicilio'><span>"+json[i].domicilio+"</span></td><td class='editable' data-campo='correo'><span>"+json[i].correo+"</span></td><td class='editable' data-campo='tel'><span>"+json[i].tel+"</span></td></tr>");
			}
		});
