...
<div class="contenedor">
	...
	$(document).ready(function() 
	{
		...
		.done(function(json) {
			...
			{
				$('.editinplace').append(
					"<tr><td class='editable' data-campo='nombre'><span>"+json[i].nombre+"</span></td><td class='editable' data-campo='usuario'><span>"+json[i].usuario+"</span></td><td class='puesto'>"+json[i].puesto+"</td></tr>");
			}
		});
